...
{{--    Kod yazısını görüntüsünü güzelleştirmek için--}}
    ...
    <div class="container">
        <div class="header-top d-flex justify-content-between align-items-center header-border header-h">
            ...
            <div class="header-logo">
                <a href="{{ route('home') }}">
                    <img src="{{  asset("assets/images/logo.png") }}" class="logo-h img-fluid">
                </a>
            </div>
                ...
                <section class="categories bg-white shadow-sm">
                    ...
                    <ul class="list-group m-0" id="categoryCollapse">
                        @foreach($categories as $category)
                            <li class="px-3 py-3">
                                <a href="{{ route('front.categoryArticles',['category' => $category->slug]) }}">{{ $category->name }}
                                    <span class="float-end me-3"> <i class="fa fa-circle" style="color: {{ $category->color }}"></i></span>
                                </a>
                            </li>
                        @endforeach
                    </ul>
