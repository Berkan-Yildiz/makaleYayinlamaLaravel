            ...
            <form action="" id="formFilter">
                <div class="row">
                    <div class="col-3 my-2">
                        <input type="text" class="form-control" placeholder="İsim" name="name" value="{{ request()->get('name') }}">
                    </div>
                    <div class="col-3 my-2">
                    ...
                    <div class="col-3 my-2">
                        <select class="js-states form-control" id="selectParentCategory" name="parent_id" tabindex="-1" style="display: none; width: 100%">
                    ...
                    <div class="col-3 my-2">
                        <select class="form-select" name="user_id">
                            <option value="{{ null }}">User Seç</option>
                    ...
                    <div class="col-3 my-2">
                        <select class="form-select" id="selectParentCategory" name="status" aria-label="Status" >
                            <option value="{{ null }}">Status Seçin</option>
                            <option value="0" {{ request()->get('status') === 0 ? "selected" : "" }}>Pasif</option>
                            <option value="1" {{ request()->get('status') === 1 ? "selected" : "" }}>Aktif</option>
                        </select>
                    </div>
                    <div class="col-3 my-2">
                        <select class="form-control" id="selectParentCategory" name="feature_status" aria-label="Feature Status" >
                            <option value="{{ null }}">Feature Status Seçin</option>
                    ...
                    <hr>
                    <div class="col-6 mb-3 mx-auto d-flex">
                        <button class="btn btn-primary w-50 me-2" type="submit">Filtrele</button>
                        <button class="btn btn-danger w-50" type="submit" id="btnClearFilter">Filtreyi Temizle</button>
                    </div>
                    <hr>
                ...
                <x-slot:rows>
                    @foreach($list as $category)
                        <tr>
                            ...
                            <td title="{{ $category->description }}">{{ substr($category->description, 0, 50) }}</td>
