...
@section("content")
    <x-bootstrap.card>
        ...
        <x-slot:body>
            <form action="{{ route("articles.index") }}" method="GET" id="formFilter">
                <div class="row">
                ...
                <x-slot:rows>
                    @foreach($list as $article)
                        <tr id="row-{{ $article->id }}">
                            ...
                            <td>   <span data-bs-container="body" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="{{ substr( $article->titlr , 0, 20) }}">
                            ...
                            <td>
                                <span data-bs-container="body" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="{{ substr( $article->body , 0, 20) }}">
