        ...
        <section class="col-12 mt-4">
            ...
            <div class="article-authors mt-5">
                <div class="bg-white p-4 d-flex justify-content-between align-items-center shadow-sm">
                    <img src="{{ asset($article->user->image, $settings->default_comment_profile_image) }}" alt="" width="75" height="75">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.like-comment').click(function ()
            {
                ...
                $.ajax({
                    method: "POST",
                    url: "{{ route('articles.comment.favorite') }}",
                    data: {
                        id : articleID
                    },
                    async:false,
