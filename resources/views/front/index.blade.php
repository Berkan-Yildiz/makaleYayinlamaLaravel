    ...
    @if(isset($settings) && $settings->feature_categories_is_active)
        ...
        <section class="feature-categories mt-4">
            <div class="popular-title col-md-8">
                <h2 class="font-montserrat fw-semibold">En Çok Okunan Kategoriler</h2>
            </div>
            <div class="row">
                    ...
                    >
                        ...
                        >
                            <div class="w-75">
                                ...
                                <div class="text-center text-secondary border-2 border-secondary border-top mt-4 pt-4 text-black">
                                    <h2>{{ $category->name }}</h2>
                                </div>
                                <hr>
        ...
        @foreach($lastPublishedArticles as $article)
            <div class="col-md-4 mt-4">
                ...
                <div class="most-popular-body mt-2">
                    ...
                    <div class="most-popular-date">
                        <span>{{ $article->format_publish_date }}</span> &#x25CF;
                    </div>
                </div>
            </div>
        @endforeach
...
@push("meta")
    ...
    <meta name="author" content="Berkan Yıldız">
@endpush
@section("js")
@endsection
